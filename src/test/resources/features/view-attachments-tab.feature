...
Feature: "View Attachments tab"
  Requirement CA-28 uses the proven admin authentication path and the newest visible Submitted Bonus Issue application.

  @req:CA-28
  Scenario: [admin] "View Attachments tab" for current Bonus Issue application
