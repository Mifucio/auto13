...
Feature: View History and Attachments tabs of the saved disposable Dividend Payment application

  Scenario: View the History tab of the saved disposable application
  ...
  Scenario: View the Attachments tab of the saved disposable application
    Given I open the saved disposable Dividend Payment application
